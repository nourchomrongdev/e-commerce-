        ...
        <tbody>
          {customers.map((customer) => (
            <TableRow key={customer.email} className="text-body transition hover:bg-surface-hover">
              ...
              <td data-label="Orders" className="px-4 py-3 font-medium">{customer.orders}</td>
              <td data-label="Total Spent" className="px-4 py-3 font-medium text-body-strong">{customer.totalSpent}</td>
              <td data-label="Last Order" className="px-4 py-3 text-muted">{customer.lastOrder}</td>
              <td data-label="Status" className="px-4 py-3"><Badge tone={statusTone[customer.status]}>{customer.status}</Badge></td>
