  ...
  return (
    <div className="overflow-x-auto product-responsive-table">
      <table className="w-full min-w-[760px] table-auto text-left text-xs">
        <thead className="bg-[#fcfcfe] text-[10px] font-medium uppercase tracking-[0.08em] text-[#66718e]">
          <tr>
          ...
          {products.map((product) => {
            ...
            return (
              <tr key={product.name} className="border-t border-[#edf0f5] text-[#283554] transition hover:bg-[#fffaf6]">
                ...
                <td data-label="Price" className="px-4 py-3 font-medium text-[#172141]">
                ...
                <td data-label="Status" className="px-4 py-3"><ProductStatusBadge status={product.status} /></td>
                <td data-label="Sales" className="px-4 py-3">{product.sales}</td>
                <td data-label="Created At" className="px-4 py-3 text-[#66718e]">{product.createdAt}</td>
