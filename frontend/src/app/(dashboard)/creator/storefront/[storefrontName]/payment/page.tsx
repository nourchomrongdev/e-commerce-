...
export default function StorefrontPaymentPage({
  ...
  const storefront =
    storefrontData[decodeURIComponent(params.storefrontName)] ||
            ...
            {savedMethods.length ? (
              <div className="mt-4 flex items-center justify-center gap-3">
                ...
                <button
                  ...
                  className="grid h-10 w-10 shrink-0 place-items-center rounded-full border border-[#e0e5ef] bg-white text-lg text-[#33405d] transition hover:border-primary hover:text-primary disabled:opacity-40"
                >
                  ‹
                </button>
