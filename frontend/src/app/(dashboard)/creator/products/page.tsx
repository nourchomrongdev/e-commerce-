    ...
    <div className="mx-auto w-full max-w-[1400px]">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/creator/products/create" className="inline-flex items-center gap-2 rounded-lg bg-primary px-3.5 py-2 text-xs font-semibold text-white no-underline shadow-sm transition hover:bg-[#e65d00]">
      ...
      <section className="mt-7 overflow-hidden rounded-2xl border border-border bg-white shadow-sm">
        <div className="flex flex-col gap-4 border-b border-divider px-5 pt-4 sm:px-6">
          ...
          <div className="flex flex-col gap-2 pb-4 sm:flex-row sm:justify-end">
            ...
            <button type="button" className="inline-flex h-9 items-center justify-center gap-2 rounded-lg border border-border-control px-3 text-xs font-medium text-muted hover:bg-surface-control">
