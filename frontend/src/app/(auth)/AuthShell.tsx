...
import { useState, type ChangeEvent, type FormEvent, type HTMLInputTypeAttribute, type ReactNode } from "react";
...
const copy = {
  ...
  reset: [
    "Reset",
    "your password",
    "No worries! Enter your email and we will send you a code to reset your password.",
  ],
} as const;
...
export function PreventSubmit({
  ...
  return (
    ...
    >
      <fieldset disabled={disabled} className="space-y-4 disabled:cursor-not-allowed disabled:opacity-70">
        {children}
      </fieldset>
    </form>
  );
