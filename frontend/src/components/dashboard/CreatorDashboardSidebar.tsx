  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed top-20 z-[60] grid h-9 w-9 place-items-center rounded-br-lg border-b border-r border-[#e1e5ee] bg-white text-2xl leading-none text-[#1d294b] shadow-md transition-[left,background-color] duration-300 hover:bg-accent-light focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 max-[900px]:hidden ${collapsed ? "left-0" : "left-[228px]"}`}
      >
