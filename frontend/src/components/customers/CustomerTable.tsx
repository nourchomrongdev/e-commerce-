        ...
        <tbody>
          {customers.map((customer) => (
            <TableRow key={customer.email} className="text-body transition hover:bg-surface-hover">
              ...
              <td className="py-3 font-medium">{customer.orders}</td>
              <td className="py-3 font-medium text-body-strong">{customer.totalSpent}</td>
              <td className="py-3 text-muted">{customer.lastOrder}</td>
              <td className="py-3"><Badge tone={statusTone[customer.status]}>{customer.status}</Badge></td>
