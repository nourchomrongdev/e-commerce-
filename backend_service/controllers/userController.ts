...
async function forgotPassword(req, res) {
  ...
  const response: { message: string; maskedEmail: string; otp?: string } = { message: `If the email exists, a ${otpLength}-digit OTP will be sent.`, maskedEmail: maskEmail(email) };
